...
public class VideoDto implements Serializable, Parcelable
{
    ...
    @Expose
    private String type;
    public final static Parcelable.Creator<VideoDto> CREATOR = new Creator<VideoDto>() {
        ...
        public VideoDto[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -3110946940533882391L;

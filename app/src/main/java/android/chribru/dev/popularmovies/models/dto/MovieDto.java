...
public class MovieDto implements Parcelable
{
    ...
    public final static Parcelable.Creator<MovieDto> CREATOR = new Creator<MovieDto>() {
        @SuppressWarnings({
                "unchecked"
        })
    ...
    protected MovieDto(Parcel in) {
        ...
        in.readList(this.genreDtos, (GenreDto.class.getClassLoader()));
     ...
     * @param genreDtos list of movie genreDtos
     ...
     */
    public MovieDto(Boolean adult, String backdropPath, Object belongsToCollection, Integer budget, List<GenreDto> genreDtos, String homepage, Integer id, String imdbId, String originalLanguage, String originalTitle, String overview, Double popularity, String posterPath, String releaseDate, Integer revenue, Integer runtime, String status, String tagline, String title, Boolean video, Double voteAverage, Integer voteCount) {
        super();
        this.adult = adult;
